...
Irssi::settings_add_str('mail', 'mailcheck_imap_host', 'mail.harsite.com');
Irssi::settings_add_int('mail', 'mailcheck_imap_port', 143);
Irssi::settings_add_str('mail', 'mailcheck_imap_user', 'har@harsite.com');
Irssi::settings_add_str('mail', 'mailcheck_imap_password', 'mob2127');
